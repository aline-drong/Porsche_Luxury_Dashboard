...
- Tratamento e sanitização dos dados de vendas.
- Padronização de datas, modelos, anos, preços, quilometragem, cidades, estados, formas de pagamento e status de entrega.
- Dashboard responsivo desenvolvido em HTML, CSS e JavaScript.
- Filtros interativos por:
  ...
  - Método de pagamento
- KPIs executivos.
- Gráficos dinâmicos para análise de vendas.
- Insights de negócio baseados nos dados.

## KPIs

- Total de veículos vendidos.
- Modelo mais vendido.
- Ano de modelo com maior volume de vendas.
- Cidade com maior quantidade de vendas.
...
Desenvolver uma solução completa de Business Intelligence capaz de transformar dados brutos em informações estratégicas, proporcionando análises visuais, indicadores de desempenho e suporte à tomada de decisão.
